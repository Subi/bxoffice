                            ...
                            <div className="w-full top-2 left-2 z-20 relative">
                                ...
                                <div className="absolute left-40 top-1">
                                    <div className="flex w-64 flex-col ">
                                        ...
                                        <button className="py-[.3em] items-center justify-evenly w-[100px] flex px-1 rounded  bg-blue  text-white font-medium text-sm tracking-wider hover:shadow-sm hover:shadow-blue-500/50 hover:-translate-y-[2px] transition-transform duration-200">
