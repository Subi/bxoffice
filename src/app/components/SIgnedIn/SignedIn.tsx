...
export default function SignedIn({username , userImage}:SignedInProps ){
    ...
    return (
        ...
        <div ref={ref} onClick={() => {setIsOpen(prev => !prev)}} aria-label="profileAvatar" className="bg-blue-400 border-none rounded-full mr-4 overflow-hidden relative avatar">
            <Image
        ...
        <div className={`${open ? "!hidden" : "block"} group-hover:block group-hover:animate-toolTipZoom hidden  mr-3 mt-1 absolute top-20 rounded-sm shadow-md  py-[.5] px-2 text-center bg-foreground-light`}>
